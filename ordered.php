...
<html lang="en">
  ...
  <div class="thanks">
    ...
    <h4>Your identification number is: CLA261</h4>
  </div>

  <div class="back-btn">
    <div class="btn_branch">
              <a href="index.html" class="btn-directions">Go Back to Homepage</button></a>
              <a href="orders.html" class="btn-order-now">Go Back to Menu</a>
            </div>
  </div>
